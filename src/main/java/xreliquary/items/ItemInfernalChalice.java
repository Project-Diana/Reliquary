...
public class ItemInfernalChalice extends ItemToggleable {
    ...
    protected int fluidLimit() {
        return Reliquary.CONFIG.getInt(Names.infernal_chalice, "fluid_limit");
    }
    ...
    public ItemStack onItemRightClick(ItemStack ist, World world, EntityPlayer player) {
        ...
        double yOffset = player.prevPosY + (player.posY - player.prevPosY) * movementThresholdCoefficient
            + 1.62D
            - player.yOffset;
            ...
            if (mop.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (this.isEnabled(ist) && NBTHelper.getInteger("fluidStacks", ist) + 1000 <= fluidLimit()) {
                    ...
                    if (tile instanceof IFluidHandler) {
                        ...
                        FluidStack simulatedDrainedFluid = ((IFluidHandler) tile)
                            .drain(ForgeDirection.getOrientation(mop.sideHit), fluid, false);
                ...
                if (this.isEnabled(ist)
                    && (ident.equals(ContentHelper.getIdent(Blocks.flowing_lava))
                        || ident.equals(ContentHelper.getIdent(Blocks.lava)))
                ...
                if (!this.isEnabled(ist) && NBTHelper.getInteger("fluidStacks", ist) >= 1000) {
                    ...
                    if (this.tryPlaceContainedLiquid(world, ist, xOffset, yOffset, zOffset, x, y, z)
    ...
    public boolean tryPlaceContainedLiquid(World world, ItemStack ist, double par2, double par4, double par6, int x,
        int y, int z) {
