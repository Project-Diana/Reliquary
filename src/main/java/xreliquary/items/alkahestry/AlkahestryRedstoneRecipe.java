...
public class AlkahestryRedstoneRecipe implements IRecipe {
    ...
    public boolean matches(InventoryCrafting inv, World world) {
                ...
                if (ContentHelper.getIdent(stack.getItem())
                    ...
                    .equals(ContentHelper.getIdent(Items.redstone))) {
                        ...
                        .equals(ContentHelper.getIdent(Blocks.redstone_block))) {
                            ...
                            .equals(ContentHelper.getIdent(Items.glowstone_dust))) {
                                if (valid == 0) valid = 1;
                                amount++;
                            } else if (ContentHelper.getIdent(stack.getItem())
                                .equals(ContentHelper.getIdent(Blocks.glowstone))) {
                                    if (valid == 0) valid = 1;
                                    amount += 4;
                                } else {
                                    valid = 2;
        ...
        return tome != null && valid == 1
            && NBTHelper.getInteger("redstone", tome) + amount
                <= Reliquary.CONFIG.getInt(Names.alkahestry_tome, "redstone_limit");
    }
