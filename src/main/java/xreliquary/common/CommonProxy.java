...
public class CommonProxy {
    ...
    public void preInit() {
        try {
            ...
            FMLCommonHandler.instance()
                .raiseException(e, "Reliquary failed to initiate recipies.", true);
        }
        ...
        // FluidContainerRegistry.registerFluidContainer(new FluidStack(FluidRegistry.WATER,
        // FluidContainerRegistry.BUCKET_VOLUME / 8), XRRecipes.potion(Reference.WATER_META),
        // XRRecipes.potion(Reference.EMPTY_VIAL_META));
    }
    ...
    public void init() {
        ...
        FMLCommonHandler.instance()
            .bus()
            .register(alkahestryCraftingRecipeHandler);
        FMLCommonHandler.instance()
            .bus()
            .register(alkahestryDrainRecipeHandler);
    ...
    public void initOptions() {
        ...
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.sojourner_staff,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.handgun,
        ...
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.alkahestry_tome,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.destruction_catalyst,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.elsewhere_flask,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
        ...
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.infernal_chalice,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.hero_medallion,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
            Names.pyromancer_staff,
            new ConfigReference(3).setMinimumValue(1)
                .setMaximumValue(4));
        Reliquary.CONFIG.require(
            Names.hud_positions,
        ...
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.cave_spider_fangs + "_base", new ConfigReference(15));
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.cave_spider_fangs + "_looting", new ConfigReference(10));
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.blaze_molten_core + "_base", new ConfigReference(15));
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.blaze_molten_core + "_looting", new ConfigReference(10));
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.magma_cube_molten_core + "_base", new ConfigReference(10));
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.magma_cube_molten_core + "_looting", new ConfigReference(5));
        ...
        Reliquary.CONFIG
            .require(Names.mob_drop_probability, Names.eye_of_the_storm + "_looting", new ConfigReference(5));
        ...
        Reliquary.CONFIG.require(
            Names.alkahestry_tome,
            "redstone_limit",
            new ConfigReference(250).setMinimumValue(0)
                .setMaximumValue(itemCap));
        ...
        Reliquary.CONFIG
            .require(Names.altar, "maximum_time_variance_in_minutes", new ConfigReference(5).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.altar,
            "output_light_level_while_active",
            new ConfigReference(16).setMaximumValue(16)
                .setMinimumValue(0));

        // angelic feather configs
        Reliquary.CONFIG
            .require(Names.angelic_feather, "hunger_cost_percent", new ConfigReference(50).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.angelic_feather,
            "leaping_potency",
            new ConfigReference(1).setMinimumValue(0)
                .setMaximumValue(5));
        ...
        Reliquary.CONFIG.require(
            Names.apothecary_cauldron,
            "redstone_limit",
            new ConfigReference(5).setMinimumValue(0)
                .setMaximumValue(100));
        Reliquary.CONFIG.require(
            Names.apothecary_cauldron,
            "cook_time",
            new ConfigReference(160).setMinimumValue(20)
                .setMaximumValue(32000));
        ...
        Reliquary.CONFIG.require(
            Names.destruction_catalyst,
            "mundane_blocks",
            new ConfigReference(new ArrayList<String>(ItemDestructionCatalyst.ids)));
        Reliquary.CONFIG
            .require(Names.destruction_catalyst, "gunpowder_cost", new ConfigReference(3).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.destruction_catalyst, "gunpowder_worth", new ConfigReference(1).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.destruction_catalyst,
            "gunpowder_limit",
            new ConfigReference(250).setMinimumValue(0)
        ...
        Reliquary.CONFIG.require(
            Names.destruction_catalyst,
            "explosion_radius",
            new ConfigReference(1).setMinimumValue(1)
                .setMaximumValue(5));
        ...
        Reliquary.CONFIG
            .require(Names.emperor_chalice, "hunger_satiation_multiplier", new ConfigReference(4).setMinimumValue(0));

        // ender staff configs
        Reliquary.CONFIG.require(Names.ender_staff, "ender_pearl_cast_cost", new ConfigReference(1).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.ender_staff, "ender_pearl_node_warp_cost", new ConfigReference(1).setMinimumValue(0));
        ...
        Reliquary.CONFIG.require(
            Names.glacial_staff,
            "snowball_damage_bonus_fire_immune",
            new ConfigReference(3).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.glacial_staff, "snowball_damage_bonus_blaze", new ConfigReference(6).setMinimumValue(0));
        ...
        Reliquary.CONFIG.require(
            Names.harvest_rod,
            "bonemeal_luck_percent_chance",
            new ConfigReference(33).setMinimumValue(1)
                .setMaximumValue(100));
        Reliquary.CONFIG.require(
            Names.harvest_rod,
            "bonemeal_luck_rolls",
            new ConfigReference(2).setMinimumValue(0)
                .setMaximumValue(7));
        Reliquary.CONFIG.require(
            Names.harvest_rod,
            "harvest_break_radius",
            new ConfigReference(2).setMinimumValue(0)
                .setMaximumValue(5));

        // hero's medallion config
        Reliquary.CONFIG
            .require(Names.hero_medallion, "experience_level_maximum", new ConfigReference(30).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.hero_medallion, "experience_level_minimum", new ConfigReference(0).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.hero_medallion,
            "experience_limit",
            new ConfigReference(cleanIntMax).setMinimumValue(0)
                .setMaximumValue(cleanIntMax));
        ...
        Reliquary.CONFIG.require(
            ...
            new ConfigReference(2).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.ice_magus_rod, "snowball_damage_bonus_blaze", new ConfigReference(4).setMinimumValue(0));

        // infernal claws configs
        Reliquary.CONFIG
            .require(Names.infernal_claws, "hunger_cost_percent", new ConfigReference(10).setMinimumValue(0));

        // infernal chalice configs
        Reliquary.CONFIG
            .require(Names.infernal_chalice, "hunger_cost_percent", new ConfigReference(5).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.infernal_chalice,
            "fluid_limit",
            new ConfigReference(500000).setMinimumValue(0)
                .setMaximumValue(cleanIntMax));

        // interdiction torch configs
        // see post init for entity configs
        Reliquary.CONFIG.require(
            Names.interdiction_torch,
            "push_radius",
            new ConfigReference(5).setMinimumValue(1)
                .setMaximumValue(15));
        ...
        Reliquary.CONFIG.require(
            Names.lantern_of_paranoia,
            "min_light_level",
            new ConfigReference(8).setMinimumValue(0)
                .setMaximumValue(15));
        Reliquary.CONFIG.require(
            Names.lantern_of_paranoia,
            "placement_scan_radius",
            new ConfigReference(6).setMinimumValue(1)
                .setMaximumValue(15));
        // Reliquary.CONFIG.require(Names.lantern_of_paranoia, "only_place_on_visible_blocks", new
        // ConfigReference(false));

        // lilypad of fertility configs
        Reliquary.CONFIG
            .require(Names.lilypad, "seconds_between_growth_ticks", new ConfigReference(47).setMinimumValue(1));
        Reliquary.CONFIG.require(
            Names.lilypad,
            "tile_range",
            new ConfigReference(4).setMinimumValue(1)
                .setMaximumValue(15));
        Reliquary.CONFIG.require(
            Names.lilypad,
            "full_potency_range",
        ...
        Reliquary.CONFIG.require(
            Names.midas_touchstone,
            "ticks_between_repair_ticks",
            new ConfigReference(4).setMinimumValue(1)
                .setMaximumValue(cleanShortMax));
        ...
        Reliquary.CONFIG.require(
            Names.phoenix_down,
            "give_temporary_fire_resistance_if_fire_damage_killed_you",
            new ConfigReference(true));
        Reliquary.CONFIG.require(
            Names.phoenix_down,
            "give_temporary_water_breathing_if_drowning_killed_you",
            new ConfigReference(true));

        // pyromancer staff configs
        Reliquary.CONFIG
            .require(Names.pyromancer_staff, "hunger_cost_percent", new ConfigReference(5).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.pyromancer_staff,
            "fire_charge_limit",
            new ConfigReference(250).setMinimumValue(0)
        ...
        Reliquary.CONFIG
            .require(Names.pyromancer_staff, "fire_charge_worth", new ConfigReference(1).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.pyromancer_staff, "ghast_absorb_worth", new ConfigReference(1).setMinimumValue(0));
        Reliquary.CONFIG.require(
            Names.pyromancer_staff,
            "blaze_powder_limit",
            new ConfigReference(250).setMinimumValue(0)
                .setMaximumValue(itemCap));
        Reliquary.CONFIG
            .require(Names.pyromancer_staff, "blaze_powder_cost", new ConfigReference(1).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.pyromancer_staff, "blaze_powder_worth", new ConfigReference(1).setMinimumValue(0));
        Reliquary.CONFIG
            .require(Names.pyromancer_staff, "blaze_absorb_worth", new ConfigReference(1).setMinimumValue(0));

        // rending gale configs
        Reliquary.CONFIG.require(
            Names.rending_gale,
            "charge_limit",
            new ConfigReference(cleanShortMax).setMinimumValue(0)
                .setMaximumValue(cleanIntMax));
        ...
        Reliquary.CONFIG
            .require(Names.rending_gale, "charge_feather_worth", new ConfigReference(100).setMinimumValue(1));
        ...
        Reliquary.CONFIG.require(
            Names.rod_of_lyssa,
            "level_cap_for_leveled_formula",
            new ConfigReference(100).setMinimumValue(1)
                .setMaximumValue(900));
        Reliquary.CONFIG.require(
            Names.rod_of_lyssa,
            "flat_steal_failure_percent_rate",
            new ConfigReference(10).setMinimumValue(0)
                .setMaximumValue(100));
        ...
        Reliquary.CONFIG.require(
            Names.sojourner_staff,
            "max_capacity_per_item_type",
            new ConfigReference(1500).setMinimumValue(1)
                .setMaximumValue(itemCap));
        Reliquary.CONFIG.require(
            Names.sojourner_staff,
            "max_range",
            new ConfigReference(30).setMinimumValue(1)
                .setMaximumValue(30));
        Reliquary.CONFIG.require(
            Names.sojourner_staff,
            "tile_per_cost_multiplier",
            new ConfigReference(6).setMinimumValue(6)
                .setMaximumValue(30));

        // twilight cloak configs
        Reliquary.CONFIG.require(
            Names.twilight_cloak,
            "max_light_level",
            new ConfigReference(4).setMinimumValue(0)
                .setMaximumValue(15));
        ...
        Reliquary.CONFIG.require(
            Names.void_tear,
            "item_limit",
            new ConfigReference(2000000000).setMinimumValue(0)
                .setMaximumValue(cleanIntMax));
    ...
    public void postInit() {
        ...
        Reliquary.CONFIG
            .require(Names.interdiction_torch, "entities_that_can_be_pushed", new ConfigReference(entityNames));
        Reliquary.CONFIG
            .require(Names.interdiction_torch, "projectiles_that_can_be_pushed", new ConfigReference(projectileNames));

        Reliquary.CONFIG.require(Names.rending_gale, "entities_that_can_be_pushed", new ConfigReference(entityNames));
        Reliquary.CONFIG
            .require(Names.rending_gale, "projectiles_that_can_be_pushed", new ConfigReference(projectileNames));
    ...
    public void initRecipeDisablers() {
        ...
        for (int i = 0; i < Reliquary.CONTENT.registeredObjectNames.size(); i++) {
            Reliquary.CONFIG.require(
                ...
                Reliquary.CONTENT.registeredObjectNames.get(i)
                    .replace(':', '_'),
                new ConfigReference(true));
        }
    }
    ...
    public void registerEntities() {
        EntityRegistry
            .registerModEntity(EntityHolyHandGrenade.class, "entityHGrenade", 0, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry
            .registerModEntity(EntityGlowingWater.class, "entityHolyWater", 1, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry.registerModEntity(
            EntitySpecialSnowball.class,
            "entitySpecialSnowball",
            2,
            Reliquary.INSTANCE,
            128,
            5,
            true);
        EntityRegistry
            .registerModEntity(EntityNeutralShot.class, "entityNeutralShot", 3, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry
            .registerModEntity(EntityExorcismShot.class, "entityExorcismShot", 4, Reliquary.INSTANCE, 128, 5, true);
        ...
        EntityRegistry
            .registerModEntity(EntityConcussiveShot.class, "entityConcussiveShot", 7, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry
            .registerModEntity(EntityBusterShot.class, "entityBusterShot", 8, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry
            .registerModEntity(EntitySeekerShot.class, "entitySeekerShot", 9, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry.registerModEntity(EntitySandShot.class, "entitySandShot", 10, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry
            .registerModEntity(EntityStormShot.class, "entityStormShot", 11, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry.registerModEntity(
            EntityAttractionPotion.class,
            "entitySplashAphrodite",
            12,
            Reliquary.INSTANCE,
            128,
            5,
            true);
        EntityRegistry
            .registerModEntity(EntityThrownXRPotion.class, "entityThrownPotion", 13, Reliquary.INSTANCE, 128, 5, true);
        EntityRegistry.instance()
            .lookupModSpawn(EntityThrownXRPotion.class, false)
            .setCustomSpawning(null, false);
        EntityRegistry.registerModEntity(
            EntityFertilePotion.class,
        ...
        EntityRegistry.registerModEntity(
            EntityEnderStaffProjectile.class,
            "entityEnderStaffProjectile",
            23,
            Reliquary.INSTANCE,
            128,
            5,
