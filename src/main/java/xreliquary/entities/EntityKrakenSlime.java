...
public class EntityKrakenSlime extends EntityThrowable {
    ...
    protected void onImpact(MovingObjectPosition object) {
        ...
        if (object.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY
            && object.entityHit instanceof EntityLiving) {
        ...
        for (int count = 0; count < 6; ++count) {
            ...
            worldObj.spawnParticle(
                "slime",
                posX - motionX * amplifier + worldObj.rand.nextDouble(),
                posY - motionY * amplifier + worldObj.rand.nextDouble(),
                posZ - motionZ * amplifier + worldObj.rand.nextDouble(),
                motionX,
                motionY,
                motionZ);
        }
    ...
    public void onUpdate() {
        ...
        for (int count = 0; count < 2; ++count) {
            ...
            worldObj.spawnParticle(
                "slime",
                posX - motionX * amplifier,
                posY - motionY * amplifier,
                posZ - motionZ * amplifier,
                motionX,
                motionY,
                motionZ);
        }
