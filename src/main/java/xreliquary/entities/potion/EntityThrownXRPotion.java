...
public class EntityThrownXRPotion extends EntityThrowable {
    ...
    // public EntityThrownXRPotion(World p_i1791_1_, double p_i1791_2_, double p_i1791_4_, double p_i1791_6_, int
    // p_i1791_8_)
    // {
    ...
    public EntityThrownXRPotion(World p_i1792_1_, double p_i1792_2_, double p_i1792_4_, double p_i1792_6_,
        ItemStack ist) {
    ...
    protected void entityInit() {
        super.entityInit();
        this.getDataWatcher()
            .addObjectByDataType(11, 2);
    }

    public int getEntityColor() {
        int color = this.getDataWatcher()
            .getWatchableObjectInt(11);
        return color;
    }
