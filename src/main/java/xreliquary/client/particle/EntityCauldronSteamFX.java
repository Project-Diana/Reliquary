...
public class EntityCauldronSteamFX extends EntityReddustFX {
    ...
    public EntityCauldronSteamFX(World world, double x, double y, double z, double xMot, double yMot, double zMot,
    ...
    public EntityCauldronSteamFX(World world, double x, double y, double z, float sizeAndLifespanLoL, float red,
